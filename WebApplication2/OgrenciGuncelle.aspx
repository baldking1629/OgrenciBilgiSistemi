        ...
        <div class="form-group">
           <%-- <div>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtOgrAd" runat="server" CssClass="form-control" Width="200px" Enabled="false"></asp:TextBox>
            </div>
            <br>
            <div>
                <asp:Label for="TxtOgrSoyad" runat="server">Öğrenci Soyadı</asp:Label>
                <asp:TextBox ID="TxtOgrSoyad" runat="server" CssClass="form-control" Width="200px" Enabled="false"></asp:TextBox>
            </div>
            <br>
            <div>
