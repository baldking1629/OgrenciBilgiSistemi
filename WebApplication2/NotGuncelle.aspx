     ...
     <form id="Form1" runat="server">
        <div class="form-group">
            <div>
                ...
                <asp:TextBox ID="TxtDersAd" runat="server" CssClass="form-control" Width="200px" Enabled="false"></asp:TextBox>
            </div>
            <br>
            <div>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtOgrAdSoyad" runat="server" CssClass="form-control" Width="200px" Enabled="false"></asp:TextBox>
            </div>
            <br>
            <div>
                <asp:Label for="TxtOgrSınav1" runat="server">SINAV1</asp:Label>
                <asp:TextBox ID="TxtOgrSınav1" runat="server" CssClass="form-control" Width="200px" Enabled="false"></asp:TextBox>
            </div>
            <br>
            <div>
                <asp:Label for="TxtOgrSınav2" runat="server">SINAV2</asp:Label>
                <asp:TextBox ID="TxtOgrSınav2" runat="server" CssClass="form-control" Width="200px" Enabled="false"></asp:TextBox>
            </div>
            <br>
            <div>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtOgrOrt" runat="server" CssClass="form-control" Width="200px" Enabled="false"></asp:TextBox>
            </div>
            <br />
            <div>
                <asp:Label for="TxtOgrDurum" runat="server">DURUM</asp:Label>
                <asp:TextBox ID="TxtOgrDurum" runat="server" CssClass="form-control" Width="200px" Enabled="false"></asp:TextBox>
            </div>
            <br />
